...
1. **Fork and Clone**: Fork the repository and clone it to your local machine.
    ```bash
    git clone https://github.com/sageteamorg/django-sage-timezone.git
    cd django-sage-timezone
    ```
...
6. **Run Code Quality Checks**: Ensure code quality with pre-commit, Ruff, and Pylint.
    ...
    ruff check django-sage-timezone --fix
    black django-sage-timezone/
    isort django-sage-timezone/
    pylint django-sage-timezone
    ```
